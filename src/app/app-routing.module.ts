...
import {BookingFlightComponent} from "./pages/website/booking-flight/booking-flight.component";
...
const routes: Routes = [
  ...
  {
    path: '',
    component: LayoutComponent, // The Parent Component of all those ChildComponents
    children: [
      {
        path:'airport',
