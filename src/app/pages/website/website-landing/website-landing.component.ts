...
export class WebsiteLandingComponent {
  ...
  private readonly REGISTER_MODEL = 'registerModel';
  private readonly LOGIN_MODEL = 'loginModel';
  ...
  openRegister() {
    const model = document.getElementById(this.REGISTER_MODEL);
    if (model !== null) {
  ...
  openLogin() {
    const model = document.getElementById(this.LOGIN_MODEL);
    if (model !== null) {
      model.style.display = "block";
    }
  }
